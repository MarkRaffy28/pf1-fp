...
const Login = () => {
  return (
    <main
      style={{
        minHeight: "100vh",
        background: `linear-gradient(rgba(255,255,255,0.8), rgba(255,255,255,0.8)), url("https://dl.dropbox.com/scl/fi/8c99mzgw618jhoy3woufr/login_background.jpg?rlkey=fmrp839osv7ywffxdwqz66bez&st=66ol4xqi&dl=0")`,
